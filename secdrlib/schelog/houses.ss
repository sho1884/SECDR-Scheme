...
;;; Exercise 14.1 (iv) from Sterling&Shapiro.  

(define-functor house hue nation pet drink cigarette)
...
(define %houses-clues
  (rel (row-of-houses abode1 abode2 abode3 abode4 abode5 abode6 abode7
    ...
    [(row-of-houses
	 ...
	 (%unify [list (_) (_) abode8 (_) (_)] row-of-houses)
	 (%drink abode8 'milk)

	 (%unify [list abode9 (_) (_) (_) (_)] row-of-houses)
	 (%nation abode9 'norway)

	 (%member abode10 row-of-houses)
	 (%member abode11 row-of-houses)
	 (%or (%adjacent abode10 abode11) (%adjacent abode11 abode10))
	 (%cigarette abode10 'chesterfield)
	 (%pet abode11 'fox)

	 (%member abode12 row-of-houses)
	 (%or (%adjacent abode7 abode12) (%adjacent abode12 abode7))
	 (%pet abode12 'horse)
	 ...
	 (%or (%adjacent abode9 abode15) (%adjacent abode15 abode9))
	 (%hue abode15 'blue)])]))
